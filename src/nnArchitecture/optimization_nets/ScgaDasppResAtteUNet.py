...
from src.nnArchitecture.optimization_nets.improve_components.DenseASPP import DenseASPP3D
...
class ScgaDasppResAtteUNet(nn.Module):
    def __init__(self, in_channels=4, out_channels=4, f_list=[32, 64, 128, 256], trilinear=True):
        ...
        self.Conv2 = EncoderBlock3D(f_list[0], f_list[1])
        self.Conv3 = EncoderBlock3D(f_list[1], f_list[2])
        self.Conv4 = EncoderBlock3D(f_list[2], f_list[3])
...
if __name__ == '__main__':
    ...
    test_unet(model_class=ScgaDasppResAtteUNet)
