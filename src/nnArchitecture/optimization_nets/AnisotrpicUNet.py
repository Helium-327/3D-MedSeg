...
from src.nnArchitecture.optimization_nets.improve_components.HybridAttnBlcok import HybridAttnBlock
...
class AnisotrpicUNet(nn.Module):
    def __init__(self, in_channels=4, out_channels=4, f_list=[32, 64, 128, 256], trilinear=True):
        ...
        self.Conv1 = HybridAttnBlock(in_channels, f_list[0])
        self.Conv2 = HybridAttnBlock(f_list[0], f_list[1])
